...
async def avg_fiscal_income(con, city: str):
    cur = con.cursor()
...
async def top10_transactions(con, city: Union[str, None] = None):
    cur = con.cursor()
    if city :
...
async def transactions_count(con, city: Union[str, None] = None, year: Union[str, None] = None):
    cur = con.cursor()
...
async def avg_sq2_price(con, buildingType: str, year: Union[str, None] = None):
    cur = con.cursor()
    if year :
...
async def n_rooms_count(con, nb_room: str, year: Union[str, None] = None):
    cur = con.cursor()
    if not year :
...
async def n_rooms_distrib(con, year: Union[str, None] = None):
    cur = con.cursor()
    if year :
...
async def avg_sq2_price_by_building(con, buildingType: Union[str, None] = None, year: Union[str, None] = None):
    cur = con.cursor()
...
async def transactions_count_by_district(con, year: Union[str, None] = None):
    cur = con.cursor()
    if year :
...
async def transactions_count_under_income(con, fiscalIncome2YearsAgo: str, year: str):
    cur = con.cursor()
...
async def top10_dynamic_cities(con, year: Union[str, None] = None):
    cur = con.cursor()
    if year :
...
async def cheapest_flats_sq2_price_top10_cities(con):
    cur = con.cursor()
...
async def highest_houses_sq2_price_top10_cities(con):
    cur = con.cursor()
    req = f'''SELECT ville, AVG(ROUND(prix/surface_habitable)) as prix2moyen FROM transactions_sample ts
